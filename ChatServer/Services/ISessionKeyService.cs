...
namespace ChatServer.Services
{
    public interface ISessionKeyService
    {
        ...
        Task<(BigInteger serverPublicKey, BigInteger p, BigInteger g, byte[] encryptedChatKey, byte[] encryptedChatIv)?> InitiateKeyExchange(int chatId, int userId, BigInteger clientPublicKey);
